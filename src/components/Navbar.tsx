        ...
        {open && (
          ...
          >
            ...
            <div className="flex flex-col items-center  space-y-6 mt-6 w-3/4">
              <Link href='/contact' onClick={handleCloseMenu} className="w-full px-6 py-3 border border-yellow-500 text-yellow-500 text-center text-base font-semibold rounded-full hover:bg-yellow-500 hover:text-black transition">
                Contact
              </Link>
              <button
                onClick={handleExploreNow}
