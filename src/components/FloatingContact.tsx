...
export default function FloatingContact() {
  ...
  const whatsappMessage = "Hello! I'd like to know more about eVehicles.";
  const emailAddress = "support@evechicles.com";
      ...
      <AnimatePresence>
        {showCallout && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 bg-white text-gray-900 p-4 rounded-xl shadow-2xl max-w-xs"
          >
